                    ...
                    for _date in stock.get('results').get(_year).get(_typ):
                        ...
                        if not check_itr_res:
                            ...
                            for _key, _val in stock.get('results').get(_year).get(_typ).get(_date).get('dre').items():
                                ...
                                # Resultado Bruto
                                if 'resultadobruto' in _key:
                                    result_dict['resultado_brt'] = _val
                            ...
                            print(f'Y: {_year} | {_typ} | {_date} | "BPP"')
                            ...
                            if get_month == 12 or get_month == 3:
                                ...
                                # TODO: TROCA REALIZADA DE NONE para 0 para não quebrar! Acomapnahr o resultado.
                                # Get LAST
